        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-lg-12">
                    ...
                    <h1 class="display-4 text-white mt-5 mb-2">Add Retrospective</h1>
    ...
    <div class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
            <div class="w-full sm:max-w-xl mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
                <form method="POST" action="{{route('retrospective.store',['project'=> $project->id, 'sprint'=>$sprint->id, 'user'=>$user->id])}}">
                    @csrf
                    ...
                    <div class="mt-4">
                        ...
                        <label for="improve">Things that can be improved</label><br>
