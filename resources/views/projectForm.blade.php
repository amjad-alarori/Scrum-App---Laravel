            ...
            <form method="POST" action="{{route('project.store')}}">
                ...
                <div class="mt-4">
                    ...
                    <input class="form-input rounded-md shadow-sm block mt-1 w-full" id="mission" type="text"
                           name="mission" autocomplete="mission" value="{{old('mission')}}">
                    @error('mission')
                    <p class='text-sm text-red-600 mt-2'>{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mt-4">
                    ...
                    <input class="form-input rounded-md shadow-sm block mt-1 w-full" id="vision" type="text"
                           name="vision" autocomplete="vision" value="{{old('vision')}}">
                    @error('vision')
                    <p class='text-sm text-red-600 mt-2'>{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mt-4">
                    ...
                    <input class="form-input rounded-md shadow-sm block mt-1 col-sm-5" id="deadline" type="date"
                           name="deadline" autocomplete="deadline" value="{{old('deadline')}}">
                    @error('deadline')
                    <p class='text-sm text-red-600 mt-2'>{{ $message }}</p>
                    @enderror
                </div>
