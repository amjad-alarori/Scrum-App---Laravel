            ...
            <div class="row h-100 align-items-center">
                <div class="col-lg-12">
                  ...
                  {{--  @foreach ($projects as $project): --}}
                    <h1 class="display-4 text-white mt-5 mb-2">{{-- }} {{$project->title}} --}}Project 1</h1>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 mb-5">
             ...
             {{--   @foreach ($projects as $project): --}}
                <p>{{-- {{$projects->description}} --}}Lorem ipsum dolor sit amet, consectetur adipisicing elit. A deserunt neque tempore recusandae animi soluta quasi? Asperiores rem dolore eaque vel, porro, soluta unde debitis aliquam laboriosam. Repellat explicabo, maiores!</p>
            ...
            <div class="col-md-3 mb-5">
                <div class="card h-100">
                    ...
                    <div class="card-footer">
                        <a href="/addSprint" class="btn btn-primary">Add sprint</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-5">
                <div class="card h-100">
                    ...
                    <div class="card-footer">
                        <a href="/addTeam" class="btn btn-primary">Go to teams</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-5">
