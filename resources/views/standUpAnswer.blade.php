        ...
        @foreach($dailyStandUp->questions as $question)
            <form method="POST"
                ...
                <div class="row px-4 pt-4 pb-2 bg-white sm:p-6">
                    ...
                    <textarea class="form-input rounded-md shadow-sm mx-4 mt-1 block w-full" id="question{{$question->id}}" name="question{{$question->id}}">{{old('question'.$question->id)}}</textarea>
