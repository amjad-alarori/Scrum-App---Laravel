    ...
    <header class="bg-primary py-5 mb-5">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-lg-12">
                    <h1 class="display-4 text-white mt-5 mb-2">Sprint Review</h1>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 mb-5">
                <h2>Sprint Reviewinformatie</h2>
                <hr>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. A deserunt neque tempore recusandae animi soluta quasi? Asperiores rem dolore eaque vel, porro, soluta unde debitis aliquam laboriosam. Repellat explicabo, maiores!</p>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Omnis optio neque consectetur consequatur magni in nisi, natus beatae quidem quam odit commodi ducimus totam eum, alias, adipisci nesciunt voluptate. Voluptatum.</p>
                <a class="btn btn-primary" href="#">Meer informatie over Sprint Review</a>
            </div>
        ...
        <div class="row">
            <div class="col-md-3 mb-5">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Tekst toevoegen</h4>
                        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sapiente esse necessitatibus neque sequi doloribus.</p>
                    </div>
                    <div class="card-footer">
                        <a href="#" class="btn btn-primary">Voeg een Tekst toe</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-5">
                <div class="card h-100">
                    ...
                    <div class="card-footer">
                        <a href="#" class="btn btn-primary">Stel het Tekst samen</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-5">
